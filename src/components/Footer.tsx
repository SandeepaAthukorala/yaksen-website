...
export default function Footer() {
    ...
    return (
        <footer className="py-10 sm:py-12 px-4 sm:px-6 border-t border-white/10 bg-black/80 backdrop-blur-xl text-center text-sm text-yaksen-muted relative z-10">
